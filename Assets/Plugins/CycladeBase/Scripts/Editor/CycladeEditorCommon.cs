...
namespace CycladeBaseEditor.Editor
{
    public class CycladeEditorCommon
    {
        ...
        public readonly Cache<GUIStyle> RichHelp2 = new(() =>
        {
        ...
        public readonly Cache<GUIStyle> BoldTextField = new(() =>
        {
        ...
        public static List<T> FindAllFromScene<T>(Scene scene, bool includeInactive = false)
        {
            var allComponentns = scene.GetRootGameObjects()
                .SelectMany(q => q.GetComponentsInChildren<T>(includeInactive)).ToList();
        ...
        public void DrawUILine(int thickness = 2, int padding = 10)
        {
