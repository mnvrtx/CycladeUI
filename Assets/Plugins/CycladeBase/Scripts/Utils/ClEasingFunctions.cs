...
{
    public static class ClEasingFunctions
    {
        public enum Ease
        {
            EaseInQuad = 0,
        ...
        public static float EaseInElastic(float start, float end, float value)
        {
            ...
            if (Mathf.Abs(value) < float.Epsilon) return start;

            if (Mathf.Abs((value /= d) - 1) < float.Epsilon) return start + end;

            if (Mathf.Abs(a) < float.Epsilon || a < Mathf.Abs(end))
            {
                a = end;
                s = p / 4;
            }
        ...
        public static float EaseInOutElastic(float start, float end, float value)
        {
            ...
            if (Mathf.Abs((value /= d * 0.5f) - 2) < float.Epsilon) return start + end;
        ...
        public static float EaseInOutElasticD(float start, float end, float value)
        {
            ...
            if (value < 1)
            {
                ...
                return -5f * NaturalLogOf2 * a * Mathf.Pow(2f, 10f * value) *
                       ...
                       a * Mathf.PI * d * Mathf.Pow(2f, 10f * value) * Mathf.Cos(2 * Mathf.PI * (d * value - s) / p) /
                       p;
            }
